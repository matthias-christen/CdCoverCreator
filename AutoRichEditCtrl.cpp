...
BOOL CAutoRichEditCtrl::Create (DWORD dwStyle, const RECT& rcRect, CWnd* pParentWnd, UINT nID)
{
...
{
	if (nChar == VK_ESCAPE)
		GetParent ()->SendMessage (WM_COMMAND, MAKELONG (GetDlgCtrlID (), AEN_ESCAPE), (LPARAM) GetSafeHwnd ());
	else
