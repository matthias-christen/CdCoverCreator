...
{
public:
	CWebCDCovers(HINSTANCE hInst);
	virtual ~CWebCDCovers();

	bool GetList (CString strLetter, HWND hwndList);
	bool SearchCovers (CString strKeywords, HWND hwndList);
	bool DownloadImage (CString strLetter, CString strName, CString strFilename, CString& strLocalFilename);
...
private:
	bool RetrieveList (int nIndex, CString strCriteria, HWND hwndList, CString strMsg);
