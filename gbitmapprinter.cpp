...
// C++ class source file: "GBitmapPrinter.cpp"
//
// Copyright (C) 2001 Damon Chandler and Michael Fötsch
// See the Terms of Use in TERMS.TXT
//
// Created by Damon Chandler <dmc27@ee.cornell.edu>
// Updates can be downloaded at: <http://graphicsBB.itgo.com>
//
   ...
   )
{
   ...
   if (GetObject(hDIBSection, dibSize, &ds) == dibSize)
   {
      ...
      short num_ct_entries = ds.dsBmih.biClrUsed;
